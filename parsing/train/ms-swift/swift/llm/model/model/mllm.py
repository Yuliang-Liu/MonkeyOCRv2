...
def get_model_tokenizer_monkeyocrv2(model_dir, *args, **kwargs):
    # model_cls = get_class_from_dynamic_module('modeling_monkeyocrv2_vision.MonkeyOCRv2VisionTransformer', model_dir)
    # model_cls._no_split_modules = ['VisionBlock']

    # try:
    #     model_cls = get_class_from_dynamic_module('modeling_monkeyocrv2_vision.VisionTransformerDecoder', model_dir)
    #     model_cls._no_split_modules = ['VisionBlock']
    #     print("module 'modeling_monkeyocrv2_vision' has attribute 'VisionTransformerDecoder'")
    # except:
    #     print("module 'modeling_monkeyocrv2_vision' has no attribute 'VisionTransformerDecoder'")
...
register_model(
    ModelMeta(
        ...
        architectures=['MonkeyOCRv2ForCausalLM'],
