...
class MonkeyOCRv2UndTemplate(MonkeyOCRv2Template):
    def _encode(self, inputs: StdTemplateInputs) -> Dict[str, Any]:
        ...
        if images:
            ...
            media_grid_thw = media_inputs['image_grid_thw']
            idx_list = findall(input_ids, media_token)
            merge_length = 1 #processor.image_processor.merge_size**2
...
register_template(MonkeyOCRv2TemplateMeta(MLLMTemplateType.monkeyocrv2_und, template_cls=MonkeyOCRv2UndTemplate, default_system=None))