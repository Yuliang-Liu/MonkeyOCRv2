...
vitaev2_pretrained_ckpt = os.getenv(
    'vitaev2_pretrained_ckpt',
    r'/data/dlluo/code/ttd/OSTF/work_dirs/pretrained_ckpt/vitaev2-s_pretrain_text.pth')

custom_imports = dict(
    imports=[
        'mmseg.models.backbones.vitaev2_dct',
...
model = dict(
    ...
    backbone=dict(
        type='ViTAEv2Dct',
        pretrained_checkpoint=vitaev2_pretrained_ckpt,
        in_channels=3,
        out_indices=(0, 1, 2, 3),
...
optim_wrapper = dict(
    ...
    paramwise_cfg=dict(
        custom_keys={
            'backbone.vitae': dict(lr_mult=0.1),
        }))
